            ...
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    <li style="padding: 10px 0 0;">
                        <a href="facultyhome.php" class="waves-effect"><i class="fa fa-clipboard fa-fw" aria-hidden="true"></i><span class="hide-menu">Dashboard</span></a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row" style="padding:10px">
                    <?php
                    $email = $_SESSION['email'];
                    $q = "select course_name,about,course_id,syllabus_path,start_date,end_date from course where course_name LIKE '%$search_term%'";
                    ...
                    while($rows = mysqli_fetch_array($result))
                    {
                        ...
                        echo '<div class="white-box" style="padding:30px">
                            ...
                            <a href='.$rows["syllabus_path"].' target="_blank" type="button" >View Syllabus</a>
                            </div>
                            </div>';
                    }
                    ?>
