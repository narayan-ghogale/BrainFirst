            ...
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    <li style="padding: 10px 0 0;">
                        <a href="facultyassignment.php" class="waves-effect"><i class="fa fa-arrow-left fa-fw" aria-hidden="true"></i><span class="hide-menu">Assignment Page</span></a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row" style="padding:10px">
                    <div class="col-md-12">
                            ...
                            <br><br>
                              <button type="submit" class="myButton" name="addassignment" id="submit">Add</button>
                            </form>
                       <!-- </div>
                    </div>-->
                </div>
