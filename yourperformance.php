        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row bg-title" style="text-align: center;">
                    <h4 class="course-name" style="font-size: 22px">Your performances</h4> 
                    <!-- /.col-lg-12 -->
                </div>
                <div class="col-md-12">
                    <div class="myBox" >
                        <?php
                            ...
                            while($row1 = mysqli_fetch_array($result1))
                            {
                                ...
                                $q2 = "select * from quiz_ans where student_id='$student_id' AND quiz_id='$quiz_id'";
                                ...
                                {
                                    $ques_num = $row2['ques_num'];
                                    $ans = $row2['answer'];
                                    $q3 = "select correct_answer from quiz_ques where quiz_id='$quiz_id' AND ques_num='$ques_num'";
                                ...
                                if($num==0)
                                    echo '<tr>
                                                <td colspan="4">You did not attend this quiz :(</td>
                                            </tr>';

                                        echo '<tr>
                                                <td colspan="3">Total Marks</td>
                                                <td>'.$total_marks.' out of '.$total_ques.'</td></tr>';
                                echo '</table><br><br><br>';
                            }
