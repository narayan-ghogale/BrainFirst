        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="" class="waves-effect"><i class="fa fa-line-chart fa-fw" aria-hidden="true"></i><span class="hide-menu">Grades</span></a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row bg-title" style="text-align: center;">
                    <h4 class="course-name" style="font-size: 22px">Your Grades for <?php echo $course_name;?></h4> 
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="course-name">Quizzes</h4> </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="row" style="padding:10px">
                    <div class="myBox" >
                    <?php
                        $q = "select grade,about_quiz from quiz_grade qg,quiz_info qi where qi.course_id = '$course_id' AND student_id = '$student_id' AND qg.quiz_id=qi.quiz_id"; 
                        $result = mysqli_query($con, $q);
                        $num = mysqli_num_rows($result);
                        if($num == 0)
                        {
                            echo '<div class="white-box">
                                <p class="field">No Recent Quizzes attended</p> </div>';
                        }
                        else
                        {
                            echo '<table align="center">';
                                echo '<caption style="text-align: center; font-size: 20px">Quiz Performances</caption>';
                                echo '<tr>
                                    <th>Quiz</th>
                                    <th>Your Grade</th>
                                </tr>';
                ...
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="course-name" style="width: 300px">Assignments</h4> </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="row" style="padding:10px">
                    ...
                    <?php
                        ...
                        {
                        	echo '<table align="center">';
                                echo '<caption style="text-align: center; font-size: 20px">Assignment Performances</caption>';
                                echo '<tr>
                                    <th>Assignment</th>
                                    <th>Your Grade</th>
                                </tr>';
