...
<head>
    ...
    <title>Add Quiz - BrainFirst</title>
    <!-- Bootstrap Core CSS -->
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row bg-title" style="text-align: center;">
                    <h4 class="course-name" style="font-size: 22px">Add a Quiz for <?php echo $course_name;?></h4> 
                    <!-- /.col-lg-12 -->
                </div>
                <div class="row" style="padding:10px">
                    <div class="col-md-12">
                              <form class="form" method="POST" enctype="multipart/form-data" action="addquestions.php">
                              <!--<h2>Create A Quiz</h2>-->
                              <p type="Description"><input placeholder="Enter description of the quiz in brief" type="text" name='about_quiz' required></input></p>
                              <p type="Start time"><input placeholder="When will the quiz start?" type="datetime-local" name="starttime" id ='stime' required></input></p>
                              <p type="End Time:"><input placeholder="When will quiz end?" type="datetime-local" name="endtime" id ='etime' required></input></p>
                                <p type="Total questions"><input placeholder="Enter number of questions for the quiz" name="no_of_questions" id="no_of_questions" type="number" min=1 required></p>
                            <br><br>
                              <button class="myButton" type="submit" name="addquiz" id=submit>Add Quiz</button>
                            </form>
                </div>
            </div>
            <!-- /.container-fluid -->
